-- Migration: Add band_chat_messages table
-- Run this in your Supabase SQL Editor to fix the band chat functionality
...
SELECT 'band_chat_messages table created successfully' as status;
